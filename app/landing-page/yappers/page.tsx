...
export default function ParallaxPage() {
  ...
  return (
    <>
      {/* Global fonts moved outside JSX to avoid Turbopack CSS parsing bug */}
      <link
        rel="preload"
        href="https://cdn.prod.website-files.com/671752cd4027f01b1b8f1c7f/6717e399d30a606fed425914_PPNeueCorp-WideUltrabold.woff2"
        as="font"
        type="font/woff2"
      ...
      <link
        rel="preload"
        href="https://cdn.prod.website-files.com/6819ed8312518f61b84824df/6819ed8312518f61b84825ba_PPNeueMontreal-Medium.woff2"
        as="font"
        type="font/woff2"
        crossOrigin="anonymous"
      />
        ...
        <div className="relative overflow-hidden w-full">
            ...
            <div className="absolute inset-0 h-[120%] w-full">
              ...
              >
                ...
                <div
                  ...
                  className="absolute inset-0 flex min-h-screen w-full items-center justify-center"
                >
                  <h2
                    className="
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-xl">
              We help Yappers gain real engagement and build stronger connections with their audience. Whether you’re sharing your thoughts, telling your story, or sparking meaningful discussions.
            </p>
