...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-23 right-2 z-50 sm:bottom-10 sm:right-6 flex items-center justify-center w-12 h-12 rounded-lg
      bg-neutral-200 text-neutral-800 shadow-lg transition-all duration-300 hover:bg-neutral-300 
      dark:bg-neutral-800 dark:text-yellow-400 dark:hover:bg-neutral-700 cursor-pointer
      focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 dark:focus:ring-yellow-500"
